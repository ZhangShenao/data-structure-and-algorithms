...
/**
 * @author ZhangShenao
 * @date 2023/8/16 9:56 AM
 * @description: 有序数组中找到第一个>=target的索引
 */
public class FindFirstGreaterOrEquals {
     ...
     */
    private static int findFirstGreaterOrEquals(int[] arr, int target) {
        //边界条件校验
